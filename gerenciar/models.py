...
class matricula(models.Model):
    ...
    valor_total = models.CharField(max_length=6, null=False, blank=False, verbose_name="Valor da Mensalidade")
...
class avaliacao(models.Model):
    ...
    d2 = models.DecimalField(max_digits=4, decimal_places=2, null=False, blank=False, verbose_name="Bicipital")
    d3 = models.DecimalField(max_digits=4, decimal_places=2, null=False, blank=False, verbose_name="Subescapular")
    d4 = models.DecimalField(max_digits=4, decimal_places=2, null=False, blank=False, verbose_name="Torácica")
    ...
    d8 = models.DecimalField(max_digits=4, decimal_places=2, null=False, blank=False, verbose_name="Cutânea da Coxa")
    #d9 = models.DecimalField(max_digits=4, decimal_places=2, null=False, blank=True, verbose_name="RCQ")
...
class ficha_de_saude(models.Model):
    ...
    def __str__(self):
        return f'{self.nome} - {self.fuma} - {self.bebe}'
...
class medicamento(models.Model):
    ...
    def __str__(self):
        return f'{self.nome} - {self.antidepressivos} - {self.betabloqueadores} - {self.ansiolitico}'
...
class treinoA(models.Model):
    ...
    aexc_1 = models.ForeignKey(cadastrar_exercicio, on_delete=models.CASCADE, related_name='treino1', default=None, null=False, verbose_name='1')
    aexc_2 = models.ForeignKey(cadastrar_exercicio, on_delete=models.CASCADE, related_name='treino2', default=None, null=False, verbose_name="2")
    aexc_3 = models.ForeignKey(cadastrar_exercicio, on_delete=models.CASCADE, related_name='treino3', default=None, null=False, verbose_name="3")
    aexc_4 = models.ForeignKey(cadastrar_exercicio, on_delete=models.CASCADE, related_name='treino4', default=None, null=False, verbose_name="4")
    aexc_5 = models.ForeignKey(cadastrar_exercicio, on_delete=models.CASCADE, related_name='treino5', default=None, null=False, verbose_name="5")
    aexc_6 = models.ForeignKey(cadastrar_exercicio, on_delete=models.CASCADE, related_name='treino6', default=None, null=False, verbose_name="6")
    aexc_7 = models.ForeignKey(cadastrar_exercicio, on_delete=models.CASCADE, related_name='treino7', default=None, null=False, verbose_name="7")
    aexc_8 = models.ForeignKey(cadastrar_exercicio, on_delete=models.CASCADE, related_name='treino8', default=None, null=False, verbose_name="8")
    aexc_9 = models.ForeignKey(cadastrar_exercicio, on_delete=models.CASCADE, related_name='treino9', default=None, null=False, verbose_name="9")
    aexc_10 = models.ForeignKey(cadastrar_exercicio, on_delete=models.CASCADE, related_name='treino10', default=None, null=False, verbose_name="10")
    aexc_11 = models.ForeignKey(cadastrar_exercicio, on_delete=models.CASCADE, related_name='treino11', default=None, null=False, verbose_name="11")
    aexc_12 = models.ForeignKey(cadastrar_exercicio, on_delete=models.CASCADE, related_name='treino12', default=None, null=False, verbose_name="12")
